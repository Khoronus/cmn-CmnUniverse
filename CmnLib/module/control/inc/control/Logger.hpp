...
#ifndef CMNLIB_CONTROL_LOGGER_HPP__ 
#define CMNLIB_CONTROL_LOGGER_HPP__ 
...
//----------------------------------------------------------------------------
#if !defined(CMNLIB_NO_LOGGER)

#define LogAssert(condition, message) \
    if (!(condition)) \
    { \
		CmnLib::control::Logger(__FILE__, __FUNCTION__, __LINE__, message).Assertion(); \
    }

#define LogError(message) \
	CmnLib::control::Logger(__FILE__, __FUNCTION__, __LINE__, message).Error()

#define LogWarning(message) \
	CmnLib::control::Logger(__FILE__, __FUNCTION__, __LINE__, message).Warning()

#define LogInformation(message) \
	CmnLib::control::Logger(__FILE__, __FUNCTION__, __LINE__, message).Information()
...
#endif /* CMNLIB_CONTROL_LOGGER_HPP__ */
