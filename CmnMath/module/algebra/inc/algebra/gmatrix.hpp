...
#ifndef CMNMATH_ALGEBRA_GMATRIX_HPP__ 
#define CMNMATH_ALGEBRA_GMATRIX_HPP__ 
...
public:
	...
	algebra::GVector<Real> GetRow(int r) const;
	algebra::GVector<Real> GetCol(int c) const;
...
Real Determinant(GMatrix<Real> const& M)
{
    ...
    if (M.GetNumRows() == M.GetNumCols())
    {
        numericalmethod::GaussianElimination<Real>()(M.GetNumRows(), &M[0], nullptr,
...
#endif /* CMNMATH_ALGEBRA_GMATRIX_HPP__ */