...
#ifndef CMNMATH_ARITHMETIC_BSNUMBER_HPP__
#define CMNMATH_ARITHMETIC_BSNUMBER_HPP__
...
{
    template <typename UIntegerType> inline
		CmnMath::arithmetic::BSNumber<UIntegerType> abs(CmnMath::arithmetic::BSNumber<UIntegerType> const& number)
    {
