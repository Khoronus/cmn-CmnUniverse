...
#ifndef CMNMATH_ARITHMETIC_BSRATIONAL_HPP__
#define CMNMATH_ARITHMETIC_BSRATIONAL_HPP__
...
#endif /* CMNMATH_ARITHMETIC_ARITHMETIC_HPP__ */

namespace std
{
    template <typename UIntegerType> inline
		CmnMath::arithmetic::BSRational<UIntegerType> abs(
	CmnMath::arithmetic::BSRational<UIntegerType> const& number)
    {
