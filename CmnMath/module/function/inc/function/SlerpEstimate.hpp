...
public:
    ...
    template <int N>
    inline static algebra::Quaternion<Real> Estimate(Real t,
		algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1);
    ...
    //   }
    template <int N>
	inline static algebra::Quaternion<Real> EstimateR(Real t,
		algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1);
    ...
    //   }
    template <int N>
	inline static algebra::Quaternion<Real> EstimateRP(Real t,
		algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1, Real omcosA);
    ...
    //   }
    template <int N>
	inline static algebra::Quaternion<Real> EstimateRPH(Real t,
		algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1,
		algebra::Quaternion<Real> const& qh, Real omcosAH);
};

//----------------------------------------------------------------------------
template <typename Real> template <int N> inline
algebra::Quaternion<Real> SLERP<Real>::Estimate(Real t,
algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1)
{
...
//----------------------------------------------------------------------------
template <typename Real> template <int N> inline
algebra::Quaternion<Real> SLERP<Real>::EstimateR(Real t,
algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1)
{
    static_assert(1 <= N && N <= 16, "Invalid degree.");
...
//----------------------------------------------------------------------------
template <typename Real> template <int N> inline
algebra::Quaternion<Real> SLERP<Real>::EstimateRP(Real t,
algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1, Real omcosA)
{
    static_assert(1 <= N && N <= 16, "Invalid degree.");
...
//----------------------------------------------------------------------------
template <typename Real> template <int N> inline
algebra::Quaternion<Real> SLERP<Real>::EstimateRPH(Real t,
algebra::Quaternion<Real> const& q0, algebra::Quaternion<Real> const& q1,
algebra::Quaternion<Real> const& qh, Real omcosAH)
{
    static_assert(1 <= N && N <= 16, "Invalid degree.");
